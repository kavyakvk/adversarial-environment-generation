...
if __name__ == "__main__":
    ...
    filename = f'Results/Final/GA_{args.num_agents}{args.agent_type[0]}Agent_{args.ga_tile_size}tile_{args.ga_rate_mutation}mutation_{args.num_food}food_{args.num_blockade}blocks'
